...
DialogPopup = function() {
	Phaser.Group.call(this, this.game);
	
    //this._closeBtn;
	
	this._initDialogPopup();
	//this._initText();
	//this._initCloseBtn();
};

DialogPopup.prototype = Object.create(Phaser.Group.prototype);
DialogPopup.prototype.constructor = DialogPopup;

// Initialize
DialogPopup.prototype._initDialogPopup = function() {
...
DialogPopup.prototype._drawBgRect = function() {
	// draw outline box
...
DialogPopup.prototype._initText = function() {
...
DialogPopup.prototype._initCloseBtn = function() {
...
DialogPopup.prototype._closeDialog = function(pointer) {
	this.visible = false;
