...
GraphLayer = function(game, graph, layerParameters, layerTitle, axesParameters, dataMarkerParameters) {
	this.game = game;
	this.graph = graph;
...
GraphLayer.prototype._initAxes = function(){
	...
	this.xAxis = new GraphAxis(this.game, this.graph, xAxisParams);
	this.yAxis = new GraphAxis(this.game, this.graph, yAxisParams);
